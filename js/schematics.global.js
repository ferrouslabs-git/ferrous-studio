      ...
      case 'nav-cta':
        wrap.innerHTML = `
          <div class="nv">
            ...
            <span class="sk-pill accent" style="margin-right:8px;">Get started</span>
            <div class="avatar"></div>
          </div>`;
        break;
        ...
        wrap.innerHTML = `
          <div class="sidebar-shell">
            <div class="section">
              ...
              <div class="sk-pill accent" style="width:100%;justify-content:flex-start;">Overview</div>
              <div class="sk-pill" style="width:100%;justify-content:flex-start;">Users</div>
              <div class="sk-pill" style="width:100%;justify-content:flex-start;">Reports</div>
              <div class="sk-pill" style="width:100%;justify-content:flex-start;">Settings</div>
            </div>
          </div>`;
        break;
      ...
      case 'sidenav-workspace':
        wrap.innerHTML = `
          <div class="sidebar-shell">
            ...
            <div class="section">
              <div class="title">Workspace</div>
              <div class="sk-pill accent" style="width:100%;justify-content:flex-start;">Dashboard</div>
              <div class="sk-pill" style="width:100%;justify-content:flex-start;">Members</div>
              <div class="sk-pill" style="width:100%;justify-content:flex-start;">Projects</div>
            </div>
            <div class="section" style="margin-top:auto;">
              <div class="sk-pill" style="width:100%;justify-content:flex-start;">Settings</div>
            </div>
